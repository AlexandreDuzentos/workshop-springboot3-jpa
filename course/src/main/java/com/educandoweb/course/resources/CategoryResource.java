...
public class CategoryResource {
	 ...
	 * responde a requisições http get no endpoint /Categorys.
	 *  */
	@GetMapping
	...
	/*
	 * @GetMapping - Annotation para indicar que esse método
	 * responde a requisições http get no endpoint /Categorys/id
	 * 
	 ...
	 * 
	 * Quando é feita a chamada de um Category pelo id ou qualquer
	 * outro campo, o jpa automaticamente também traz os Orders associados
	 * a aquele Category,o jpa não isso de forma automatica quando eu estou
